...
// change the ID of that control to something like IDC_MYPICTURE; use the ClassWizard
// to associate a member variable (for example, m_Picture) with the control added,
// Category - Control, Variable type - CStatic; in your dialog's header file, replace the 
// variable type from CStatic to CPictureEx (don't forget to #include "PictureEx.h" and add 
// PictureEx.h and PictureEx.cpp to your project); in OnInitDialog (or anywhere you fancy), 
// add these lines:
// 
// Collapse | Copy Code
...
// 
// You can also treat CPicture as a standard CStatic, and manually create it (you'll have to, 
// if your host window is not a dialog) by calling CPictureEx::Create(), and then
// CPictureEx::Load and CPictureEx::Draw.
//////////////////////////////////////////////////////////////////////
